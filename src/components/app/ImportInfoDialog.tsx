  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="w-[90vw] max-w-2xl">
        ...
        <ScrollArea className="max-h-[60vh] pr-3 sm:pr-4"> {/* Added ScrollArea with max-height and padding for scrollbar */}
        ...
        <DialogFooter className="pt-4"> {/* Added padding-top to footer for better spacing */}
          <DialogClose asChild>
